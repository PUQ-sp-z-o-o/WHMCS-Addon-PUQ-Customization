...
<p class="callout info">All versions are available via link: [http://download.puqcloud.com/WHMCS/addon/PUQ-Customization/](http://download.puqcloud.com/WHMCS/addon/PUQ-Customization/)</p>
...
<p class="callout warning">Note that deactivating a module will delete all tables created by the module.</p>
